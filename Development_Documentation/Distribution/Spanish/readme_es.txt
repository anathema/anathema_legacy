...
Aunque el archivo .zip tiene todo, recomendamos usar los archivos especificos del Sistema 
Operativo, si hay disponible.
...
+ Genera descripciones de personajes (actualmente no disponible)
...
A pesar de nuestros esfuerzos, lo mas probable es que Anathema no esta libre de errores 
de software. Si encuentras algún problema reportarlo por medio del sitio del proyecto de 
Sourceforge, usando el "Bugs" tracker. 
...
El Diseño de la "Base de Datos de Musica" esta rota.

Un problema a sido reportado al guardar la base de datos de equipo, pero es muy elusivo. 
Favor de contactarnos si encuentras este error de software.
...
Si estas interesado en ver Anathema en tu lengua, favor de contactarnos.

En este punto no aceptamos otras personas en el equipo del desarrollo. 
...
Gracias especiales a vestrial, por quedarse conmigo en este proyecto a pesar de sus impulsos de hacer lo contrario.
Un gran "Gracias" al Sr. Ricardo Rodriguez quien ha traducido el programa al español.
Igual a Martin, por las nuevas ilustraciones.
...
A uteck, por los esfuerzo en hacer la guia de usuario.
