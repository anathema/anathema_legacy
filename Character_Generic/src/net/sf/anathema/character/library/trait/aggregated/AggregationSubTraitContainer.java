...
public class AggregationSubTraitContainer extends AbstractSubTraitContainer {
  ...
  public AggregationSubTraitContainer(ITraitRules traitRules, ITraitContext traitContext, IValueChangeChecker valueChangeChecker,
                                      ITraitType basicType, ITraitFavorization traitFavorization, String... unremovableNames) {
  ...
  protected ISubTrait createSubTrait(String name) {
    ...
    AggregatedSubTrait subTrait = new AggregatedSubTrait(aggregatedTraitRules, traitContext, valueChangeChecker, type, name);
