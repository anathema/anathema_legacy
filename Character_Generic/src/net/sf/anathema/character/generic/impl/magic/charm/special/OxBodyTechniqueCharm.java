...
public class OxBodyTechniqueCharm implements IOxBodyTechniqueCharm {
  ...
  public OxBodyTechniqueCharm(String charmId, ITraitType traitType, LinkedHashMap<String, HealthLevelType[]> healthLevels) {
    this(charmId, new ITraitType[]{traitType}, healthLevels);
  }

  public OxBodyTechniqueCharm(String charmId, ITraitType[] traitTypes, LinkedHashMap<String, HealthLevelType[]> healthLevels) {
