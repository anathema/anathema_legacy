...
import net.sf.anathema.charmentry.demo.ICostEntryPageView;
import net.sf.anathema.charmentry.demo.ICostEntryProperties;
...
public class CostEntryPage extends AbstractAnathemaWizardPage {
  ...
  private final ICostEntryProperties properties;
