...
public class PdfFirstPageEncoder implements IPdfPageEncoder {
  ...
  public PdfFirstPageEncoder(IPdfPartEncoder partEncoder, PdfEncodingRegistry registry, IResources resources, int essenceMax,
 ...
 encodeCombatStats(directContent, character, distanceFromTop, remainingHeight);*/
  ...
  private boolean hasThaumaturgy(IGenericCharacter character) {
    IPdfContentBoxEncoder thaumaturgyEncoder = registry.getThaumaturgyEncoder();
    return thaumaturgyEncoder != null && thaumaturgyEncoder.hasContent(character);
  }
