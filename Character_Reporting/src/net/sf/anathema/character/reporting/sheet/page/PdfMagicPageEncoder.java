...
public class PdfMagicPageEncoder implements IPdfPageEncoder {
  ...
  public PdfMagicPageEncoder(IResources resources, PdfEncodingRegistry encodingRegistry, PdfPageConfiguration configuration, boolean pureMagic) {
  ...
  public void encode(Document document, PdfContentByte directContent, IGenericCharacter character, IGenericDescription description) throws
    ...
    float comboHeight = encodeCombos(directContent, character, description, distanceFromTop);
    if (comboHeight > 0) {
  ...
  private float encodeCombos(PdfContentByte directContent, IGenericCharacter character, IGenericDescription description, float distanceFromTop) throws DocumentException {
