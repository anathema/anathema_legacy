...
public abstract class AbstractHealthAndMovementEncoder extends AbstractPdfEncoder implements IPdfContentBoxEncoder {
  ...
  public final void encode(PdfContentByte directContent, IGenericCharacter character, IGenericDescription description,
  ...
  private void encodeText(PdfContentByte directContent, Bounds textBounds) throws DocumentException {
    ...
    directContent.addTemplate(rectTemplate, xPosition, rectYPosition);
    PdfTemplate aggravatedTemplate = AbstractHealthAndMovemenTableEncoder.createAggravatedTemplate(directContent, Color.GRAY);
