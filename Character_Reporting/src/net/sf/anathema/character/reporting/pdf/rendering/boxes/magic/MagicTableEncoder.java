...
public class MagicTableEncoder extends AbstractStatsTableEncoder<IMagicStats, ReportContent> {

  private final IResources resources;
  private List<IMagicStats> printStats = new ArrayList<IMagicStats>();
  private final boolean sectionHeaderLines;

  public MagicTableEncoder(IResources resources, List<IMagicStats> printStats, boolean sectionHeaderLines) {
