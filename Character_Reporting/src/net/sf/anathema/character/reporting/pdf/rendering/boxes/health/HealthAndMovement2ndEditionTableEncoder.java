...
public class HealthAndMovement2ndEditionTableEncoder extends AbstractHealthAndMovementTableEncoder {

  public HealthAndMovement2ndEditionTableEncoder(IResources resources) {
    super(resources);
  }
