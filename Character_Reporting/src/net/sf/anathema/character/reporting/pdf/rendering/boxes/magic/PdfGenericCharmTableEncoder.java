...
public class PdfGenericCharmTableEncoder extends AbstractTableEncoder<ReportContent> {
  ...
  public static final int TYPE_LONG_FORM_CUTOFF = 20;

  private final IResources resources;

  public PdfGenericCharmTableEncoder(IResources resources) {
  ...
  public float getRequestedHeight(SheetGraphics graphics, ReportContent content) {
    ...
    for (ITraitType trait : getTraits(content.getCharacter())) {
      ...
      float height = graphics.getBaseFont().getWidthPoint(text, IVoidStateFormatConstants.TABLE_FONT_SIZE) + 5.794f;
