...
find /Documents/Development/Yushan/book_MoEP-Infernals -iregex ".*xml$" -exec xsltproc /Users/pauladams/Documents/Development/Yushan/-\ Tools/charm_name_extractor.xsl {} \; |\
  grep -Ev '<[^>]*>' | tr " " "\n" > $charmNames;
