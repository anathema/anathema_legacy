...
public class ReportCompiler {
  ...
  public static void main(String[] args) {
    ...
    xmlFiles.add(new File("VoidstateAbilitySubreport.xml"));
    xmlFiles.add(new File("VoidstateSingleAbilitySubreport.xml"));
    xmlFiles.add(new File("VoidstateFiveAbilityGroupSubreport.xml"));
    xmlFiles.add(new File("VoidstateTenAbilityGroupSubreport.xml"));
    xmlFiles.add(new File("VoidstateThreeGroupAbilitySetSubreport.xml"));
    xmlFiles.add(new File("VoidstateFiveGroupAbilitySetSubreport.xml"));
