...
public abstract class AbstractGenerationData implements IGenerationData {
  ...
  protected final CharacterModuleContainer container;

  public AbstractGenerationData() throws InitializationException {
    container = new CharacterModuleContainerInitializer().initContainer(
