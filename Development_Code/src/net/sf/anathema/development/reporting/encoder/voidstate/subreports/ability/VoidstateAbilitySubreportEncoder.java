...
public class VoidstateAbilitySubreportEncoder extends AbstractPagedCharacterSheetEncoder implements
  ...
  public VoidstateAbilitySubreportEncoder(CharacterType characterType, VoidStateAbilityEncoder abiltyEncoder) {
  ...
  protected ICharacterSheetPageEncoder[] getPageEncoders() {
    return new ICharacterSheetPageEncoder[] { new VoidstateAbilityPageEncoder(characterType, abilityEncoder) };
  }
  ...
  protected String getReportName() {
    return "VoidState" + characterType.name() + "AbilitySubreport";
  }
}