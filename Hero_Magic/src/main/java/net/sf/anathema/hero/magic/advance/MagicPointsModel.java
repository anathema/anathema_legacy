...
public class MagicPointsModel implements HeroModel {
  ...
  private ISpendingModel defaultMagicModel;
  private ISpendingModel favoredMagicModel;
  ...
  private void initBonusOverview(Hero hero, MagicBonusPointCalculator calculator) {
    PointModelFetcher.fetch(hero).addBonusCategory(new WeightedCategory(100, "Charms"));
    ICreationPoints creationPoints = hero.getTemplate().getCreationPoints();
    defaultMagicModel = new DefaultMagicModel(calculator, creationPoints);
    PointModelFetcher.fetch(hero).addToBonusOverview(defaultMagicModel);
    favoredMagicModel = new FavoredMagicModel(calculator, creationPoints);
  ...
  public ISpendingModel getDefaultMagicModel() {
    return defaultMagicModel;
  }

  public ISpendingModel getFavoredMagicModel() {
    return favoredMagicModel;
  }
}
