...
public enum CollegeType implements ITraitType {
  ...
  Captain, Gull, Mast, Messenger, ShipsWheel, Ewer, Lovers, Musician, Peacock, Pillar, Banner, Gauntlet, Quiver, Shield, Spear, Guardians, Key, Mask, Sorcerer, TreasureTrove, Corpse, Crow, Haywain, RisingSmoke, Sword;
