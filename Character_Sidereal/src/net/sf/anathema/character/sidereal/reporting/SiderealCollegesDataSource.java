...
public class SiderealCollegesDataSource implements IReportDataSource, ITraitDataSource {
  ...
  private final IFavorableTrait[] colleges;
  ...
  public SiderealCollegesDataSource(IGenericCharacter character, IResources resources) {
    ...
    List<IFavorableTrait> learnedColleges = new ArrayList<IFavorableTrait>();
    ...
    this.colleges = learnedColleges.toArray(new IFavorableTrait[learnedColleges.size()]);
  }
