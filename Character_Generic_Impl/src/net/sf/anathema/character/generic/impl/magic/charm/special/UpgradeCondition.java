...
public class UpgradeCondition implements ICondition {
  ...
  public UpgradeCondition(ICharmLearnableArbitrator arbitrator, ICharm charm, boolean bpUpgradeAllowed,
                          IBasicCharacterData data, Integer essenceMin, IGenericTraitCollection traitCollection,
                          Integer traitMin, ITraitType trait) {
  ...
  public boolean isFulfilled() {
    ...
    learnable = !learnable ? learnable : (essenceMin == null || traitCollection.getTrait(
            OtherTraitType.Essence).getCurrentValue() >= essenceMin);
