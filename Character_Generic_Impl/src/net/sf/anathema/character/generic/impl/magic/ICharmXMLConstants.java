...
public interface ICharmXMLConstants {
  ...
  public static final String ATTRIB_GROUP = "group"; //$NON-NLS-1$
  public static final String ATTRIB_ID = "id"; //$NON-NLS-1$
  public static final String ATTRIB_LEVEL = "level"; //$NON-NLS-1$
  public static final String ATTRIB_NAME = "name"; //$NON-NLS-1$
  public static final String ATTRIB_PAGE = "page"; //$NON-NLS-1$
  public static final String ATTRIB_POSITION_HINT = "positionHint"; //$NON-NLS-1$
  ...
  public static final String TAG_ALTERNATIVE = "alternative"; //$NON-NLS-1$
  ...
  public static final String TAG_CHARMTYPE = "charmtype"; //$NON-NLS-1$
  public static final String TAG_COMBO = "combo"; //$NON-NLS-1$
  public static final String TAG_COST = "cost"; //$NON-NLS-1$
  public static final String TAG_DURATION = "duration"; //$NON-NLS-1$
  public static final String TAG_ESSENCE = "essence"; //$NON-NLS-1$
  public static final String TAG_LEARNING = "learning"; //$NON-NLS-1$
  public static final String TAG_MARTIAL_ARTS_LEVEL = "martialArtsLevel"; //$NON-NLS-1$
  public static final String TAG_PERMANENT = "permanent"; //$NON-NLS-1$
  ...
  public static final String TAG_TEMPORARY = "temporary"; //$NON-NLS-1$
  public static final String TAG_WILLPOWER_COST = "willpower"; //$NON-NLS-1$
  public static final String TAG_ESSENCE_COST = "essence"; //$NON-NLS-1$
