...
cp Mac/background.tiff $4/.background.tiff
cp Mac/VolumeIcon.icns $4/.VolumeIcon.icns
mv Mac/DS_Store.tmp $4/.DS_Store
cp $1/Contents/Resources/Java/license.txt $4/License.txt
