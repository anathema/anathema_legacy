...
public interface IAnathemaPreferencesConstants {
  ...
  public final String SYSTEM_PREFERENCES_NODE = "anathema/system"; //$NON-NLS-1$
  public final String USER_MEMORY_NODE = "anathema/user/memory"; //$NON-NLS-1$
  public final String DIRECTORY_CHOOSER_NODE = "DirectoryChooser"; //$NON-NLS-1$
