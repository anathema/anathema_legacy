...
public interface IInfernalSpecialCharms
{
	...
	public static final IMultipleEffectCharm WHOLENESS_RIGHTFULLY_ASSUMED = new MultipleEffectCharm(
			"Infernal.WholenessRightlyAssumed", new String[] { "Crippling", "Sickness", "Poison", "Bashing" });
