...
public class PirateOutcasteDbTemplate extends AbstractDbTemplate {
  ...
  public static final TemplateType TEMPLATE_TYPE = new TemplateType(CharacterType.DB, PIRATE_OUTCASTE_SUBTYPE);

  public TemplateType getTemplateType() {
    return TEMPLATE_TYPE;
  }

  public PirateOutcasteDbTemplate(CharmCache charmProvider, IAdditionalRules rules) throws PersistenceException {
