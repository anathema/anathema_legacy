...
public class PatricianOutcasteDBTemplate extends AbstractDbTemplate {
  ...
  public static final TemplateType TEMPLATE_TYPE = new TemplateType(CharacterType.DB, PATRICIAN_OUTCASTE_SUBTYPE);

  public TemplateType getTemplateType() {
    return TEMPLATE_TYPE;
  }

  public PatricianOutcasteDBTemplate(CharmCache charmProvider, IAdditionalRules rules) throws PersistenceException {
