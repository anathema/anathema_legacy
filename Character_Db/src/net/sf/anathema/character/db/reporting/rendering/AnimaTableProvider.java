...
public class AnimaTableProvider extends AnimaTableRangeProvider implements IAnimaTableRangeProvider {
  ...
  private static final String[] BREEDING_4_RANGES = new String[]{"1-2", "3-6", "7-9", "10-14", "15+"};

  private static final String[] BREEDING_5_RANGES = new String[]{"1", "2-5", "6-8", "9-13", "14+"};

  private static final String[] BREEDING_6_RANGES = new String[]{"0", "1-4", "5-7", "8-12", "13+"};
