...
import net.sf.anathema.character.db.reporting.content.DbGreatCurseContent;
...
public class GreatCurseEncoder extends AbstractContentEncoder<DbGreatCurseContent> {

  private VirtueFlawBoxEncoder traitEncoder = new VirtueFlawBoxEncoder();

  public GreatCurseEncoder() {
    super(DbGreatCurseContent.class);
  }

  @Override
  public void encode(SheetGraphics graphics, ReportSession reportSession, Bounds bounds) throws DocumentException {
    DbGreatCurseContent content = createContent(reportSession);
