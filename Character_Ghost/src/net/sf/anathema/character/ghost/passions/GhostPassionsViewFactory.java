...
import net.sf.anathema.character.ghost.passions.view.GhostPassionsConfigurationViewProperties;
import net.sf.anathema.character.ghost.passions.view.IGhostPassionsViewProperties;
...
public class GhostPassionsViewFactory implements IAdditionalViewFactory {
  ...
  public IView createView(IAdditionalModel model, IResources resources, ICharacterType type) {
    IGhostPassionsViewProperties properties = new GhostPassionsConfigurationViewProperties(resources);
    GhostPassionsConfigurationView view = new GhostPassionsConfigurationView(properties, new MarkerIntValueDisplayFactory(resources, type));
