...
public class LearnMeritsFlawsFixture extends AbstractMeritsFlawsCharacterRowEntryFixture {

  @Override
  public void enterRow() throws Exception {
    IMeritsFlawsModel model = getModel();
    IQualitySelection<IPerk> perkSelection = createPerkSelection(!getCharacterStatistics().isExperienced());
    model.addQualitySelection(perkSelection);
  }
}