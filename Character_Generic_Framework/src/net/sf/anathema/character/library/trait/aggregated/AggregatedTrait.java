...
public class AggregatedTrait extends AbstractFavorableTrait implements IAggregatedTrait {
  ...
  public AggregatedTrait(IFavorableTraitRules traitRules, IBasicCharacterData basicData, ICharacterListening listening, ITraitContext traitContext,
                         IValueChangeChecker valueChangeChecker, ICasteType[] castes, IIncrementChecker favoredIncrementChecker,
    ...
    this.subTraits =
            new AggregationSubTraitContainer(traitRules, traitContext, valueChangeChecker, getType(), traitFavorization, unremovableSubTraits);
