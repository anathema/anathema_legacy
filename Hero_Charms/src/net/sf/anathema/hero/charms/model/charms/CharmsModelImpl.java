...
import net.sf.anathema.character.main.charm.ISpecialCharmManager;
import net.sf.anathema.character.main.charm.LearningCharmGroup;
import net.sf.anathema.character.main.charm.PrerequisiteModifyingCharms;
import net.sf.anathema.character.main.charm.options.MartialArtsOptions;
import net.sf.anathema.character.main.charm.options.NonMartialArtsOptions;
...
import net.sf.anathema.hero.charms.model.charms.context.CreationCharmLearnStrategy;
import net.sf.anathema.hero.charms.model.charms.context.ExperiencedCharmLearnStrategy;
import net.sf.anathema.hero.charms.model.charms.context.ProxyCharmLearnStrategy;
