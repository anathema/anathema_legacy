...
public class BorderUtilities {
  ...
  /** Sets the given titled border as border to the specified component and assures the title
   * text to be visually enabled/disabled when the component is enabled/disabled. */
