...
public class WizardDialog extends AbstractDialog implements IWizardContainer, IDialogConstants {
  ...
  protected JComponent createButtonBar() {
    final SmartAction backAction = new SmartAction(DisyCommonsSwingDialogMessages.WIZARD_BACK) {
      @Override
    ...
    final SmartAction nextAction = new SmartAction(DisyCommonsSwingDialogMessages.WIZARD_NEXT) {
      @Override
      protected void execute(final Component parentComponent) {
        nextPressed();
      }
