...
public class ArtifactStatisticsPresenter {
  ...
  private final EquipmentStatisticsPresenterPage<?, ?> view;
  private final ArtifactStatisticsProperties properties;

  public ArtifactStatisticsPresenter(IArtifactStatisticsModel artifactModel, EquipmentStatisticsPresenterPage<?, ?> view, ArtifactStatisticsProperties properties) {
