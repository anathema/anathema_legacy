...
import net.sf.anathema.character.equipment.creation.view.swing.WeaponPresenterPage;
...
public class AbstractWeaponPresenter {
  ...
  private final WeaponPresenterPage view;
  ...
  public AbstractWeaponPresenter(IOffensiveStatisticsModel model, IWeaponTagsModel weaponTagsModel, WeaponPresenterPage view, OffensiveStatisticsProperties properties, WeaponDamageProperties damageProperties, TagPageProperties tagProperties) {
    this.model = model;
