package net.sf.anathema.character.thaumaturgy.template;
...
public class ThaumaturgyTemplate extends Identificate implements IGlobalAdditionalTemplate {

  public static final String ID = "Thaumaturgy"; //$NON-NLS-1$

  public ThaumaturgyTemplate() {
    super(ID);
  }
