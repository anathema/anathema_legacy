...
public class AbstractCharacterPersister extends AbstractPersister {
  ...
  protected final Element restoreTrait(Element parent, String tagName, IBasicTrait trait) throws PersistenceException {
    Element traitElement = parent.element(tagName);
    restoreTrait(traitElement, trait);
    return traitElement;
  }

  protected final void restoreTrait(Element traitElement, IBasicTrait trait) throws PersistenceException {
