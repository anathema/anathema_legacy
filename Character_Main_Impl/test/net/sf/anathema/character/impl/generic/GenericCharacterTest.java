...
public class GenericCharacterTest {
  ICharacterStatistics statistics = mock(ICharacterStatistics.class);
  ...
  public void createEssenceUserWithoutPeripheralPool() throws Exception {
    ...
    when(statistics.getEssencePool()).thenReturn(new EssencePoolConfiguration(essenceTemplate, new NullAdditionalRules(), new DummyCharacterModelContext()));
  }
