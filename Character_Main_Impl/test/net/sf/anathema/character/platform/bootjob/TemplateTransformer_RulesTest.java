...
public class TemplateTransformer_RulesTest {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(new Object[][]{{"Abyssal", "RevisedLoyalAbyssal", "TemplateType.Default"},
            {"Abyssal", "RevisedRenegadeAbyssal", "RenegadeAbyssal"}, {"Dragon-Blooded", "CherakRevised", "Cherak"},
            {"Dragon-Blooded", "DreamsRevisedSubtype", "DreamsSubtype"}, {"Dragon-Blooded", "DynasticRevisedSubtype", "TemplateType.Default"},
            {"Dragon-Blooded", "ImmaculateRevisedSubtype", "ImmaculateSubtype"}, {"Dragon-Blooded", "LookshyRevisedSubtype", "LookshySubtype"},
            ...
            {"Infernal", "RevisedInfernal", "TemplateType.Default"}, {"Lunar", "CastelessRevised", "Casteless"}, {"Lunar", "DreamsRevised", "Dreams"},
            {"Lunar", "SilverPactRevised", "TemplateType.Default"}, {"Sidereal", "RevisedDreams", "Dreams"}, {"Sidereal", "RevisedRonin", "Ronin"},
            {"Sidereal", "Revised", "TemplateType.Default"}, {"Solar", "RevisedSolar", "TemplateType.Default"}, {"Solar", "DreamsRevised", "Dreams"},
            {"Solar", "DreamsRevisedEstablished", "DreamsEstablished"}, {"Solar", "DreamsRevisedInfluential", "DreamsInfluential"},
            {"Solar", "DreamsRevisedLegendary", "DreamsLegendary"}, {"Solar", "DreamsDawn", "Dreams"}, {"Solar", "DreamsDawnRevised", "Dreams"},
            {"Solar", "DreamsZenith", "Dreams"}, {"Solar", "DreamsZenithRevised", "Dreams"}, {"Solar", "DreamsTwilight", "Dreams"},
            {"Solar", "DreamsTwilightRevised", "Dreams"}, {"Solar", "DreamsNight", "Dreams"}, {"Solar", "DreamsNightRevised", "Dreams"},
            {"Solar", "DreamsEclipse", "Dreams"}, {"Solar", "DreamsEclipseRevised", "Dreams"},});
  }
