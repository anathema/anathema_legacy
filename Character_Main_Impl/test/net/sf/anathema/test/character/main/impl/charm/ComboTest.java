...
public class ComboTest {
  ...
  public void testOnlyOneExtraActionCharm() {
    ICharm extraActionCharm = DummyCharmUtilities.createCharm(CharmType.ExtraAction,
    ...
    assertFalse(comboRules.canBeAddedToCombo(combo,
            DummyCharmUtilities.createCharm(CharmType.ExtraAction, new ValuedTraitType(AbilityType.Archery, 3))));
  }
  ...
  public void testOnlyOneSimpleCharm() {
    ...
    assertFalse(comboRules.canBeAddedToCombo(combo,
            DummyCharmUtilities.createCharm(CharmType.Simple, new ValuedTraitType(AbilityType.Archery, 3))));
  }
  ...
  public void testSimpleCharmOfSamePrimaryPrerequisiteAsExtraAction() throws Exception {
    ...
    assertTrue(comboRules.canBeAddedToCombo(combo,
            DummyCharmUtilities.createCharm(CharmType.Simple, new ValuedTraitType(AbilityType.Archery, 3))));
    assertFalse(comboRules.canBeAddedToCombo(combo,
            DummyCharmUtilities.createCharm(CharmType.Simple, new ValuedTraitType(AbilityType.Athletics, 3))));
  }
  ...
  public void testAttributeSimpleCharmsCombosWithAbilityExtraAction() throws Exception {
    ...
    addCharm(DummyCharmUtilities.createCharm(CharmType.ExtraAction, new ValuedTraitType(AbilityType.Archery, 3)));
    assertTrue(comboRules.canBeAddedToCombo(combo,
            DummyCharmUtilities.createCharm(CharmType.Simple, new ValuedTraitType(AttributeType.Appearance, 3))));
  }
  ...
  public void testExtraActionCharmOfSamePrimaryPrerequisiteAsSimple() throws Exception {
    ...
    assertTrue(comboRules.canBeAddedToCombo(combo,
            DummyCharmUtilities.createCharm(CharmType.ExtraAction, new ValuedTraitType(AbilityType.Archery, 3))));
    assertFalse(comboRules.canBeAddedToCombo(combo,
            DummyCharmUtilities.createCharm(CharmType.ExtraAction, new ValuedTraitType(AbilityType.Athletics, 3))));
  }
  ...
  public void testAttributeExtraActionCombosWithAbilitySimpleCharm() throws Exception {
    ...
    addCharm(DummyCharmUtilities.createCharm(CharmType.Simple, new ValuedTraitType(AbilityType.Archery, 3)));
    assertTrue(comboRules.canBeAddedToCombo(combo,
            DummyCharmUtilities.createCharm(CharmType.ExtraAction, new ValuedTraitType(AttributeType.Dexterity, 3))));
  }
  ...
  public void testAttributeExtraActionCombosWithAbilitySupplemental() throws Exception {
    ...
    addCharm(DummyCharmUtilities.createCharm(CharmType.Supplemental, new ValuedTraitType(AbilityType.Archery, 3)));
    assertTrue(comboRules.canBeAddedToCombo(combo,
            DummyCharmUtilities.createCharm(CharmType.ExtraAction, new ValuedTraitType(AttributeType.Perception, 3))));
  }
  ...
  public void testSupplementalOfSamePrimaryPrerequisiteAsExtraAction() throws Exception {
    addCharm(DummyCharmUtilities.createCharm(CharmType.ExtraAction, new ValuedTraitType(AbilityType.Archery, 3)));
    assertTrue(comboRules.canBeAddedToCombo(combo,
            DummyCharmUtilities.createCharm(CharmType.Supplemental, new ValuedTraitType(AbilityType.Archery, 3))));
    assertFalse(comboRules.canBeAddedToCombo(combo,
            DummyCharmUtilities.createCharm(CharmType.Supplemental, new ValuedTraitType(AbilityType.Athletics, 3))));
  }
  ...
  public void testAbilitySupplementalCombosWithAttributeExtraAction() throws Exception {
    ...
    assertTrue(comboRules.canBeAddedToCombo(combo,
            DummyCharmUtilities.createCharm(CharmType.Supplemental, new ValuedTraitType(AbilityType.Awareness, 3))));
  }
  ...
  public void testAttributeSimpleCombosWithAttributeExtraAction() throws Exception {
    addCharm(DummyCharmUtilities.createCharm(CharmType.ExtraAction, new ValuedTraitType(AttributeType.Wits, 3)));
    assertTrue(comboRules.canBeAddedToCombo(combo,
            DummyCharmUtilities.createCharm(CharmType.Simple, new ValuedTraitType(AttributeType.Strength, 3))));
  }
  ...
  public void testAttributeSupplementalCombosWithAttributeExtraAction() throws Exception {
    addCharm(DummyCharmUtilities.createCharm(CharmType.ExtraAction, new ValuedTraitType(AttributeType.Wits, 3)));
    assertTrue(comboRules.canBeAddedToCombo(combo,
            DummyCharmUtilities.createCharm(CharmType.Supplemental, new ValuedTraitType(AttributeType.Strength, 3))));
  }
  ...
  public void testAttributeSimpleCombosWithAttributeSupplemental() throws Exception {
    addCharm(DummyCharmUtilities.createCharm(CharmType.Supplemental, new ValuedTraitType(AttributeType.Strength, 3)));
    assertTrue(comboRules.canBeAddedToCombo(combo,
            DummyCharmUtilities.createCharm(CharmType.Simple, new ValuedTraitType(AttributeType.Dexterity, 3))));
  }
