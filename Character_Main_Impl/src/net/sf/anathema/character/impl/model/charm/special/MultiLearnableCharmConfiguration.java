...
public class MultiLearnableCharmConfiguration implements IMultiLearnableCharmConfiguration {
  ...
  public MultiLearnableCharmConfiguration(ICharacterModelContext context, ICharmConfiguration config, ICharm charm,
    ...
    this.trait = new LimitedTrait(new TraitType(charm.getId()),
            SimpleTraitTemplate.createStaticLimitedTemplate( //$NON-NLS-1$
                    0, specialCharm.getAbsoluteLearnLimit()), new MultiLearnableIncrementChecker(),
