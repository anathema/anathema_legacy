...
import net.sf.anathema.character.reporting.extended.page.NewPdfFirstPageEncoder;
import net.sf.anathema.character.reporting.extended.page.NewPdfMagicPageEncoder;
import net.sf.anathema.character.reporting.extended.page.NewPdfSecondPageEncoder;
import net.sf.anathema.character.reporting.extended.page.PdfMagicPageEncoder;
import net.sf.anathema.character.reporting.extended.page.PdfOldStyleFirstPageEncoder;
...
public class ExtendedSheetReport implements IITextReport {
  ...
  private ExtendedEncodingRegistry getEncodingRegistry() {
    ...
    return moduleObject.getExtendedEncodingRegistry();
  }
