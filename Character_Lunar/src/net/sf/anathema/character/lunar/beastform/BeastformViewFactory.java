...
public class BeastformViewFactory implements IAdditionalViewFactory {
  ...
  public ISimpleTabView createView(IAdditionalModel model, final IResources resources) {
    IntValueDisplayFactory intValueDisplayFactory = new IntValueDisplayFactory(
        resources,
        resources.getImageIcon(IIconConstants.LUNAR_BALL));
    BeastformView view = new BeastformView(
        intValueDisplayFactory,
        new IBeastformViewProperties() {
