...
public class FirstEditionBeastformOverviewView implements IBeastformOverviewView {
  ...
  public FirstEditionBeastformOverviewView(JPanel parent, IBeastformOverviewViewProperties properties) {
