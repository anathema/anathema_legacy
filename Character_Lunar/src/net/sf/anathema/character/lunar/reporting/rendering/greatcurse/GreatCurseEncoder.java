...
public class GreatCurseEncoder implements ContentEncoder {
  ...
  public void encode(SheetGraphics graphics, ReportSession reportSession, Bounds bounds) throws DocumentException {
    ...
    IDescriptiveVirtueFlaw virtueFlaw = ((IDescriptiveVirtueFlawModel) reportSession.getCharacter().getAdditionalModel(LunarVirtueFlawTemplate.TEMPLATE_ID)).getVirtueFlaw();
