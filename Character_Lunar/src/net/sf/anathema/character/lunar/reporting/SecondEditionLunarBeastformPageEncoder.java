...
public class SecondEditionLunarBeastformPageEncoder implements IPdfPageEncoder {
  ...
  public SecondEditionLunarBeastformPageEncoder(
  ...
  public void encode(
    ...
    float remainingHeight = SecondEditionLunarBeastformPageEncoder.CONTENT_HEIGHT - distanceFromTop;
