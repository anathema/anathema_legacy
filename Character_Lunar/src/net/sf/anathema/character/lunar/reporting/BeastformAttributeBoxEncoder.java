...
import net.sf.anathema.character.reporting.sheet.util.IPdfBoxEncoder;
...
public class BeastformAttributeBoxEncoder extends AbstractPdfEncoder implements IPdfBoxEncoder {
  ...
  public BeastformAttributeBoxEncoder(BaseFont baseFont, float smallWidth, float smallHeight) {
    ...
    this.smallHeight = smallHeight - getHeaderPadding();
  }
  ...
  public void encodeContentBox(PdfContentByte directContent, Bounds contentBounds) {
    ...
    add90DegreeArc(directContent, smallMaxX, contentBounds.getMaxY() - smallHeight - ARC_SIZE, 90);
    ...
    add90DegreeArc(directContent, contentBounds.getMaxX() - ARC_SIZE, contentBounds.getMaxY() - smallHeight, 270);
