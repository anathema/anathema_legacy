...
public interface ISVGCascadeXMLConstants {
  ...
  public static final String VALUE_1500 = "1500"; //$NON-NLS-1$
  public static final String VALUE_3 = "3"; //$NON-NLS-1$
  public static final String VALUE_3000 = "3000"; //$NON-NLS-1$
  ...
  public static final String VALUE_ARROWHEAD_REFERENCE = "url(#" + VALUE_ARROWHEAD_ID + ")"; //$NON-NLS-1$ //$NON-NLS-2$
  public static final String VALUE_ARROWHEAD_VIEWBOX = "0 0 20 20"; //$NON-NLS-1$
  ...
  public static final String VALUE_HIDDEN = "hidden"; //$NON-NLS-1$
  public static final String VALUE_SVG_VERSION = "1.1"; //$NON-NLS-1$
