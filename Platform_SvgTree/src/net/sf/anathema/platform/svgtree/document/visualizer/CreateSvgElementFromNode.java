...
public class CreateSvgElementFromNode implements IVisualizableNodeVisitor {
  private final ILayer layer;
  private final Element cascadeElement;
  private final ITreePresentationProperties properties;

  public CreateSvgElementFromNode(ILayer layer, Element cascadeElement, ITreePresentationProperties properties) {
    this.layer = layer;
