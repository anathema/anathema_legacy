...
public class SwingFilterDefinitionView implements CharmFilterDefinitionView {
  private final Resources resources;
  private final CharmFilterSet filterSet;
  private FilterDefinitionListener onFinish;

  public SwingFilterDefinitionView(Resources resources, CharmFilterSet filterSet) {
