...
public class BackgroundPresenter extends AbstractTraitPresenter implements IAdvantageSubPresenter {
  ...
  private final IdentityMapping<ITrait, IBackgroundView> viewsByBackground = new IdentityMapping<ITrait, IBackgroundView>();
  ...
  private synchronized void addBackgroundView(final ITrait background) {
    ...
    IBackgroundView backgroundView = configurationView.addBackgroundView(
        deleteIcon,
  ...
  private synchronized void removeBackgroundView(ITrait background) {
    IBackgroundView view = viewsByBackground.get(background);
