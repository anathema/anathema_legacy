...
public class TraitPersister {
  ...
  public final Element saveTrait(Element parent, String tagName, IDefaultTrait trait) {
  ...
  public final Element restoreTrait(Element parent, String tagName, IDefaultTrait trait) throws PersistenceException {
    Element traitElement = parent.element(tagName);
    restoreTrait(traitElement, trait);
    return traitElement;
  }

  public final void restoreTrait(Element traitElement, IDefaultTrait trait) throws PersistenceException {
