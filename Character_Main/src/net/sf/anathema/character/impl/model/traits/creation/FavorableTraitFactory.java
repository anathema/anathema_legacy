...
public class FavorableTraitFactory extends AbstractTraitFactory {
  ...
  public FavorableTraitFactory(ITraitContext traitContext, ITraitTemplateCollection templateCollection, IAdditionalTraitRules additionalRules,
  ...
  private IFavorableTrait createCraft(ICasteType[] casteTypes, IIncrementChecker favoredIncrementChecker, FavorableTraitRules favorableTraitRules,
                                      IValueChangeChecker valueChecker) {
    String[] crafts = new String[]{"Air", "Earth", "Fire", "Water", "Wood"};
    return new AggregatedTrait(favorableTraitRules, basicCharacterData, characterListening, traitContext, valueChecker, casteTypes,
            favoredIncrementChecker, crafts);
  }
}