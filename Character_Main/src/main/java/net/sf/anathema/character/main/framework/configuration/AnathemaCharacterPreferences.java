package net.sf.anathema.character.main.framework.configuration;
...
import static net.sf.anathema.character.main.framework.configuration.ICharacterPreferencesConstants.PRINT_ALL_GENERICS;
...
import static net.sf.anathema.character.main.framework.configuration.ICharacterPreferencesConstants.PRINT_ZERO_CRAFTS;
import static net.sf.anathema.character.main.framework.configuration.ICharacterPreferencesConstants.PRINT_ZERO_INTIMACIES;
...
public class AnathemaCharacterPreferences implements IAnathemaCharacterPreferences {
  private static final IAnathemaCharacterPreferences instance =
          new AnathemaCharacterPreferences(Preferences.userRoot().node(CHARACTER_PREFERENCES_NODE));
